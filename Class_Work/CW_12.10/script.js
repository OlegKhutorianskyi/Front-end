// let nameNumb = (num1, num2)=> num1 === num2;
    
// console.log(nameNumb((1,2)))
// console.log(nameNumb((1,2)))

// let nameNumb = (num) => num < 0;
    
// console.log(nameNumb((-2)));
// console.log(nameNumb((2)));


// let isNumb = (num) => num > 0 && num < 10;
// console.log(isNumb(11));
// console.log(isNumb(8));

// let isEven = num => 10 % 2 == 0;
